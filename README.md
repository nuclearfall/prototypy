**Prototy.py** is a tool for rapid, tabletop, physical component layout and printing or for printing of your own print and play components. It merges data from your csv file and exports to pdf.
